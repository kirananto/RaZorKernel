/*
 * Copyright © 2015, Kiran Anto "kirananto" <kirananto@gmail.com>
 *
...
static int charger_control_probe(void)
{
	...
	charger_control_kobj = kobject_create_and_add("charge_control", kernel_kobj);
...
MODULE_AUTHOR("Kiran Anto <kirananto@gmail.com>");
